...
<?php if($tabledata!='No Drugs'):?>
    <?php foreach($drugPackNames  as $r): ?>
        <div class="form-group">
            <label class="control-label col-sm-3" for="drugnames"><?php echo $r->DrugName?></label>
            <div class="col-sm-9">
                <input type="checkbox" class="form-control" id="drugnames" name="drugnames[]" value="<?php echo $r->DrugId ?>">
