<?php $attributes = array('id' =>'customer_update_form' , 'class' =>'form-horizontal'); ?>



<?php if($this->session->flashdata('errors')): ?>
<script> $('#UpdatetModal').modal('show');</script>
<?php echo ($this->session->flashdata('errors')); ?>
<?php endif; ?>


<?php if($this->session->flashdata('Customer_update_unsuccess')): ?>
<?php echo ($this->session->flashdata('Customer_update_unsuccess')); ?>
<?php endif; ?>


<?php echo form_open('CustomerManagement/customerUpdate',$attributes);?>
