      ...
      <div class="modal-body">
        <form class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label class="control-label col-sm-3" for="UtelCustomer">Address:</label>
            <div class="col-sm-9"> 
                <textarea class="form-control" id="UtelCustomer" placeholder="Enter Address" min="5" cols="12" rows="4"></textarea>
            </div>
          </div>
             <div class="form-group">
            <label class="control-label col-sm-3" for="Urfid">RFID code:</label>
            <div class="col-sm-9"> 
              <input type="number" class="form-control" id="Urfid" placeholder="Enter RFID code">
            </div>
          </div>
